    ...
    <section class="inner-section about-company">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="about-img">
                        <img src="{{ asset('storage/images/about/01.jpg') }}" alt="about" /><img
                            src="{{ asset('storage/images/about/02.jpg') }}" alt="about" /><img
                            src="{{ asset('storage/images/about/03.jpg') }}" alt="about" /><img
                            src="{{ asset('storage/images/about/04.jpg') }}" alt="about" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <ul class="testi-slider slider-arrow">
                <li>
                    <div class="testi-content">
                        <a class="testi-img" href="#"><img src="{{ asset('storage/images/testimonial/01.jpg') }}"
                                alt="testimonial" /></a>
                        <div class="testi-quote">
                            ...
                            <p>
                                ...
                                provident ab ipsam sint dolores repellat inventore sequi
                                temporibus natus.
                            </p>
                ...
                <li>
                    <div class="testi-content">
                        <a class="testi-img" href="#"><img src="{{ asset('storage/images/testimonial/02.jpg') }}"
                                alt="testimonial" /></a>
                        <div class="testi-quote">
                            <i class="icofont-quote-left"></i>
                            <p>
                    ...
                    <ul class="team-slider slider-arrow">
                        <li>
                            <figure class="team-media">
                                <img src="{{ asset('storage/images/team/01.jpg') }}" alt="team" />
                                <div class="team-overlay">
                                    <a href="#" class="icofont-facebook facebook"></a><a href="#"
                                        class="icofont-twitter twitter"></a><a href="#"
                                        class="icofont-linkedin linkedin"></a>
                                </div>
                            </figure>
                            <div class="team-meta">
                        ...
                        <li>
                            <figure class="team-media">
                                <img src="{{ asset('storage/images/team/02.jpg') }}" alt="team" />
                                <div class="team-overlay">
                                    <a href="#" class="icofont-facebook facebook"></a><a href="#"
                                        class="icofont-twitter twitter"></a><a href="#"
                                        class="icofont-linkedin linkedin"></a>
                        ...
                        <li>
                            <figure class="team-media">
                                <img src="{{ asset('storage/images/team/03.jpg') }}" alt="team" />
                                <div class="team-overlay">
                                    <a href="#" class="icofont-facebook facebook"></a><a href="#"
                                        class="icofont-twitter twitter"></a><a href="#"
                                        class="icofont-linkedin linkedin"></a>
                        ...
                        <li>
                            <figure class="team-media">
                                <img src="{{ asset('storage/images/team/04.jpg') }}" alt="team" />
                                <div class="team-overlay">
                                    <a href="#" class="icofont-facebook facebook"></a><a href="#"
                                        class="icofont-twitter twitter"></a><a href="#"
                                        class="icofont-linkedin linkedin"></a>
                        ...
                        <li>
                            <figure class="team-media">
                                <img src="{{ asset('storage/images/team/05.jpg') }}" alt="team" />
                                <div class="team-overlay">
                                    <a href="#" class="icofont-facebook facebook"></a><a href="#"
                                        class="icofont-twitter twitter"></a><a href="#"
                                        class="icofont-linkedin linkedin"></a>
