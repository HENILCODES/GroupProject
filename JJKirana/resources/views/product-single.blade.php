...
style="background: url(/storage/images/single-banner.jpg) no-repeat center"
>
<div class="container">
  <h2>{{$product['name']}}</h2>
  <ol class="breadcrumb">
        ...
        <div class="col-lg-6">
          <ul class="product-navigation">
            <li class="product-nav-prev">
              <a href="#"
                ...
                <span class="product-nav-popup"
                  ><img src="{{asset("storage/images/product/02.jpg")}}" alt="product" /><small
                    >green chilis</small
                  ></span
                ></a>
            </li>
            <li class="product-nav-next">
              <a href="#"
                ...
                ><span class="product-nav-popup"
                  ><img src="{{asset("storage/images/product/03.jpg")}}" alt="product" /><small
                    >green chilis</small
                  ></span
                ></a
              >
          ...
          <div class="details-content">
            ...
            <h3 class="details-price">
              <del style="margin-right: 10px !important">₹{{$product['price']+10}}</del
              ><span class="fw-bold">₹{{$product['price']}} </span
              ><span style="color: rgb(152, 111, 255) !important">
                {{$product['rate']}}</span
              >
            </h3>
